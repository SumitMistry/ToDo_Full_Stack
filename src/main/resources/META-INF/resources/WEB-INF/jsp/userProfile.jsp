        ...
        <div>
          <hr>
             ...
             <form:form method="post" modelAttribute="userProfile_obj_modelAttribute">
                    ...
                    <form:input type="text" path="uid" required="required" disabled="true"   size="50" />
                    ...
                    <form:input type="text" path="username"  disabled="true"  size="50"  />
                    ...
                    <form:input type="text" path="f_name" required="required"  size="50"   />
                    <form:errors path="f_name"  cssClass="text-warning"  />
                    </fieldset>

                    <fieldset class="mb-3">
                    <form:label path="l_name"> Last Name : </form:label>
                    <form:input type="text" path="l_name" required="required"  size="50"  />
                    <form:errors path="l_name"  cssClass="text-warning"  />
                    </fieldset>

                    <fieldset class="mb-3">
                    <form:label path="city"> City : </form:label>
                    <form:input type="text" path="city"    size="50"  />
                    ...
                    <form:input type="text" path="phone"   size="50"   />
                    ...
                    <form:input type="text" path="userAuth.user_role" value="${userProfile_obj_modelAttribute.userAuth.userRoleAsString}"  disabled="true"  size="50" />
                    ...
                    <fieldset class="mb-3">
                    <form:label path="userAuth.user_role"> Roles : </form:label>
                    <form:input type="text" path="userAuth.user_role" value="${userProfile_obj_modelAttribute.userAuth.user_role}"  disabled="true"  size="50" />
                    ...
                    <form:input type="text" path="userAuth.created_date" value="${userProfile_obj_modelAttribute.userAuth.password_raw}" disabled="true"   size="50"   />
                    ...
                    <form:input type="text" path="userAuth.password_encoded" value="${userProfile_obj_modelAttribute.userAuth.password_encoded}"  disabled="true"   size="90"   />
                    ...
                    <form:input type="text" path="userAuth.created_date" value="${userProfile_obj_modelAttribute.userAuth.created_date}" required="required" disabled="true"    size="90"   />
