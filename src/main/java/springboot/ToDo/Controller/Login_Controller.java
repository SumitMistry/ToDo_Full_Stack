...
///////////////////////   LOGIN (REGULAR GOOD UI)    ///////////////
    ...
    public String actual_login_happens_here( @RequestParam("uid_email") String usernr,      //  @RequestParam is used to extract individual parameter values from the request URL or submitted form data
...
///////////////////////   LOGIN (My made)    ///////////////
    ...
    @RequestMapping(value = { "login2", "login1" }, method = RequestMethod.GET)
    public String get_login_page2(){
        return "login_get2";
    }

    @RequestMapping(value = {"login2", "login1"}, method = RequestMethod.POST)
