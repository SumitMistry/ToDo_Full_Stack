...
public class Todo {
    ...
    @GeneratedValue(strategy = GenerationType.IDENTITY)  //this informs that "uid" will automatically generated by the DATABASE using an <identity> column
                                //this instructs database to utilize its built-in auto-incrementing column feature for generating primary key values
    @NotNull
